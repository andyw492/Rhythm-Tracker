#ifndef RHYTHMACCURACY_CPP
#define RHYTHMACCURACY_CPP
...
// performs calculations given audio info
// can be used to get accuracy of each note, overall accuracy, etc.
...
public:
	...
	RhythmAccuracy(AudioInfo info)
	{
		...
		// loads values into beatDifferences and expectedNoteLocations
	...
	vector<int> getExpectedNoteLocations()
	{
	...
	vector<double> getBeatDifferences()
	{
...
private:
	...
	void findExpectedNoteLocations()
	{
		...
		cout << "shortest note " << audioInfo.getShortestNote() << endl;
